...
router.get('/order',(req,res)=>{
    ...
    res.sendFile(path.join(__dirname,"../../public/client/html/orderPage.html"));
});
...
router.post('/bankOrder',async(req,res)=>{
    ...
    try{
        ...
        body.business_num == undefined ? "" : query.order_busi = body.business_num;
        body.money_phone == undefined ? "" : query.order_mp = body.money_phone[0] + "-" + body.money_phone[1] + "-" + body.money_phone[2];
...
router.get('/orderSuccess/:query', (req,res)=>{
    res.sendFile(path.join(__dirname,"../../public/client/html/orderSuccess.html"));
});
